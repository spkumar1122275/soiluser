...
data class MainUser(
    ...
    @ColumnInfo(name = "main_user_role") val role: String? = null,
    @ColumnInfo(name = "main_user_emp_no") val empNo: Int? = null,
    @ColumnInfo(name = "main_user_department_name") val departmentName: String? = null,
    @ColumnInfo(name = "main_user_department_location") val departmentLocation: String? = null
) {
