        ...
        if (role == Roles.MAIN_USER) {
            ...
            saveTerminalUserUseCase.executeSaveTerminalUser(
                TerminalUsers(
                    ...
                    canCancelRefund = Constants.IPTAL_IADE,
                    canCollectPayment = Constants.TAHSILAT,
                    canViewCashiers = Constants.KASIYER_GORUTULEME,
                    canAddEditCashiers = Constants.KASIYER_EKLEME_DUZENLEME,
                    canDeleteCashiers = Constants.KASIYER_SILME,
                    canViewProducts = Constants.URUN_GORUNTULEME,
                    canAddEditProducts = Constants.URUN_EKLEME_DUZENLEME,
                    canDeleteProducts = Constants.URUN_SILME,
                    canViewAllReports = Constants.TUM_RAPORLARI_GORUNTULEME,
                    canSaveSendReports = Constants.RAPOR_KAYDET_GONDER,
                    canManagePos = Constants.POS_YONETIMI,
